...
require(['app/anticross', 'app/editobject', 'app/graphlayout','app/graphviewer','app/depgraphlib'],
function   (anticross, editobject, graphlayout,graphviewer,depgraphlib) {
  return depgraphlib;
});
define("base.depgraph.main", function(){});
